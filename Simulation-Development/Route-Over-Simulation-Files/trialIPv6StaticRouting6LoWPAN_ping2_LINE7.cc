...
Ptr<Socket> sink = Socket::CreateSocket (n6, tid); //this is the definition of the sink on node 3(final node {0,1,2,3})
...
//node 0 //Source Node
Inet6SocketAddress remote0 = Inet6SocketAddress(deviceInterfaces.GetAddress (6,1), port); //this should be the final destination => the interface should be:
