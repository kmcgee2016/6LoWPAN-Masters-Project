...
///PCAP traces:
//Layer 3 PCAP
internetv6.EnablePcapIpv6All(std::string ("wsn_rOver_V6_PCAP_L5-1200Bytes"));
//Layer 2 PCAP
lrWpanHelper.EnablePcap(std::string ("wsn_rOverL2_PCAP_L5-1200Bytes"),lrwpanDevices, false);
