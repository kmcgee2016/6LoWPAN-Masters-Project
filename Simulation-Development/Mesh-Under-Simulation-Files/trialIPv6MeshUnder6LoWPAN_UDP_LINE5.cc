...
uint32_t numPackets = 20; // packets
...
///PCAP traces:
//Layer 3 PCAP
internetv6.EnablePcapIpv6All(std::string ("wsnV6_PCAP_LINE3_UDP_50Bytes"));
//Layer 2 PCAP
lrWpanHelper.EnablePcap(std::string ("wsnL2_PCAP_LINE3_UDP_50Bytes"),lrwpanDevices, true);
...
Simulator::ScheduleWithContext (source->GetNode ()->GetId (), Seconds (10.0), &GenerateTraffic, source, packetSize, numPackets, interPacketInterval);
