...
ping6_SRC.SetRemote (deviceInterfaces.GetAddress (4, 1));
...
///PCAP traces:
//Layer 3 PCAP
internetv6.EnablePcapIpv6All(std::string ("mUnder_V6_PING_LINE5_PCAP-1200Bytes"));
//Layer 2 PCAP
lrWpanHelper.EnablePcap(std::string ("mUnder_L2_PING_LINE5_PCAP-1200Bytes"),lrwpanDevices, true);
