...
dev2->GetMac()->SetMeshParentAddress(Mac16Address("00:02"));
...
///PCAP traces:
//Layer 3 PCAP
internetv6.EnablePcapIpv6All(std::string ("wsnV6_PING_PCAP-1200Bytes"));
//Layer 2 PCAP
lrWpanHelper.EnablePcap(std::string ("wsnL2_PING_PCAP-1200Bytes"),lrwpanDevices, true);
