...
//KMG:
extern int _printBufferStatistics(int argc, char **argv);//print out
#ifdef MODULE_CONFIG
...
extern int _router_output(int argc, char **argv);
#endif
#endif
...
const shell_command_t _shell_command_list[] = {
    ...
    {"buffers", "Packet Buffer details", _printBufferStatistics},
#ifdef MODULE_CONFIG
    ...
    { "routerOutput", "Get router stats(5s)", _router_output },
